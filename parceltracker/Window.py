...
# This class is meant to be subclassed by ParcelTrackerWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseParcelTrackerWindow object.
        """
        builder = get_builder('ParcelTrackerWindow')
        new_object = builder.get_object("parcel_tracker_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a ParcelTrackerWindow object with it in order to finish
        initializing the start of the new ParcelTrackerWindow instance.
        """
        ...
        try:
            from parcel_tracker import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for parcel-tracker."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for parcel-tracker."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the ParcelTrackerWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the ParcelTrackerWindow is closed."""
